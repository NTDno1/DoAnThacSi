...
# Mục đích: tạo báo cáo hoàn chỉnh từ các file 00..07
...
OUTPUT_FILE = BASE_DIR / "BaoCaoDeAn_ThacSi_NguyenTienDat_Full.md"
...
def merge_files():
    ...
    full = "\n\n---\n\n".join(parts)
    full = f"<!-- Bao cao do an thac si - Nguyen Tien Dat -->\n\n{full}\n"
